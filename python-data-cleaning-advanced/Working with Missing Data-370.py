...
total_killed=killed["total_killed"]
killed_mask=killed_manual_sum!=total_killed
# killed_mask=[killed_manual_sum[i]==total_killed[i] for i in killed.index]
...
vehicle_df = mvc[[col for col in mvc.columns if 'vehicle' in col]].copy()
...
# and not mvc[c_col]].isnull()    
                # and mvc[c_col]].isnull()
