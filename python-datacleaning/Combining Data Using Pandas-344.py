...
merged_right= pd.merge(left=three_2015, right=three_2016, on='Country', how="right")
...
happiness2015.rename(columns={'Happiness.Score': 'Happiness Score'}, inplace=True)
happiness2016.rename(columns={'Happiness.Score': 'Happiness Score'}, inplace=True)

combined=pd.concat([happiness2015,happiness2016,happiness2017],axis=0)
# #merge(left=happiness2015,right=happiness2016, on='c')
